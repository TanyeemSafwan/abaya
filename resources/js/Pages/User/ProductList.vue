...
watch([selectedBrands, selectedCategories, currentSort], () => {
              ...
              <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                ...
                <DialogPanel
                  ...
                  <form class="mt-4 border-t border-gray-200">
                    ...
                    <div class="flex items-center justify-between space-x-3 p-2">
                      <div class="basis-1/3">
                    ...
                    <Disclosure as="div" class="border-b border-gray-200 py-6 px-2" v-slot="{ open }">
                      ...
                      <DisclosurePanel class="pt-6">
                        <div class="space-y-4">
                          <div v-for="brand in brands" :key="brand.id" class="flex items-center">
                            <input :id="`filter-brand-${brand.id}`" :value="brand.id" type="checkbox"
                              v-model="selectedBrands"
                              class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                            <label :for="`filter-brand-${brand.id}`" class="ml-3 text-sm text-gray-600">{{
                              brand.name }}</label>
                          </div>
                        </div>
                      </DisclosurePanel>
                ...
                <transition enter-active-class="transition ease-out duration-100"
                  ...
                  <MenuItems
                    ...
                    <div class="py-1">
                      ...
                      <a @click.prevent="changeSort(option.value)"
                      :href="'#'"
                        :class="[currentSort === option.value ? 'font-medium text-gray-900' : 'text-gray-500', active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm']">{{
                          option.name }}</a>
                      </MenuItem>
                    </div>
                  </MenuItems>
          ...
          <section aria-labelledby="products-heading" class="pb-24 pt-6">
            ...
            <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div class="lg:col-span-3">
                ...
                <nav>
                <!-- <Component 
                  :is="props.products.meta.links.url ? 'Link' : 'span'"
                ...
                <ul class="inline-flex -space-x-px">
                  <li>
                    <a v-for="(link) in props.products.meta.links" :key="link.label" :href="link.url"
                      class="px-4 p-2 h-10 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white cursor-pointer"
                      :class="[(link.url ? '': 'font-semibold text-sm shadow-sm opacity-50 cursor-not-allowed'), (link.active ? 'bg-red-300 text-gray-500': '')]"
                      v-html="link.label"
                      >
                    </a>
                    </li>
